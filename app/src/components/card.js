...
export function CardContato({ nome, email, telefone, imagem_url, papel, profissao}) {
  return (
    <div
    ...
    >
      <div className="flex flex-1 flex-col p-8">
        <img alt="" src={imagem_url} className="mx-auto h-32 w-32 flex-shrink-0 rounded-full" />
